...
# =============================================================================
# Use StructuredTool when your tool accepts more than one parameter or needs
# explicit field-level validation and descriptions.
#
# Migration note: StructuredTool.from_function() is the recommended factory.
# Direct constructor usage is being phased out.
# Requires pydantic>=2.7.
# =============================================================================
